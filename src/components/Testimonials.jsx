      ...
      <div className="flex flex-wrap justify-center">
        {testimonials.map((test, index) => (
          <div className="w-full sm:w-1/2 lg:w-1/3 px-4 py-2" key={index}>
            <div className=" bg-neutral rounded-md p-6 text-md border border-x-neutral-800 font-thin">
              <p className="">{test.text}</p>
              <div className="flex mt-8 items-start">
                <img src={test.image} alt="test" className="w-12 h-12 rounded-full border borderneutral-300" />
                <div>
                  <h6>{test.user}</h6>
